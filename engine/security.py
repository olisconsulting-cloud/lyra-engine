...
HARD_BLOCKED_PATTERNS = {
    ...
    "urllib.request": "Kein direkter Internet-Zugriff. Nutze web_search/web_read oder erstelle Mock-Daten.",
    "urllib.urlopen": "Kein direkter Internet-Zugriff. Nutze web_search/web_read oder erstelle Mock-Daten.",
    "requests.get": "Kein requests.get(). Nutze web_read Tool oder erstelle Mock-Daten/simuliere lokal.",
    "requests.post": "Kein requests.post(). Du kannst KEINE echten HTTP-POST-Calls machen. Erstelle Mock-Daten oder simuliere lokal.",
    "httpx.get": "Kein httpx.get(). Nutze web_read Tool oder erstelle Mock-Daten.",
    "httpx.post": "Kein httpx.post(). Du kannst KEINE echten HTTP-POST-Calls machen. Erstelle Mock-Daten oder simuliere lokal.",
    "httpx.Client": "Kein httpx.Client(). Nutze web_search/web_read oder erstelle Mock-Daten.",
